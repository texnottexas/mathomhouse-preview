document.addEventListener('DOMContentLoaded', function () {
    // Theme is handled by header.js (dark by default; light if localStorage='light').
    // No duplicate theme init needed here.
    ...
    window.submitModalFeedback = function () {
      ...
      // Note: feedback is submitted via Google Form above.
      // Discord notifications require a server-side proxy to avoid exposing webhook URLs in client code.
